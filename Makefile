...
all:
	g++ -fopenmp -g landau-wang-omp-2d.cpp -o landau-wang-omp-2d -lboost_system -lboost_filesystem -ffast-math -flto -march=native -msse4.2 -funroll-loops -xhost -O3
	g++ -fopenmp -g landau-wang-omp-3d.cpp -o landau-wang-omp-3d -lboost_system -lboost_filesystem -ffast-math -flto -march=native -msse4.2 -funroll-loops -xhost -O3
2d:
	g++ -fopenmp -g landau-wang-omp-2d.cpp -o landau-wang-omp-2d -lboost_system -lboost_filesystem -ffast-math -flto -march=native -msse4.2 -funroll-loops -xhost -O3
3d:
	g++ -fopenmp -g landau-wang-omp-3d.cpp -o landau-wang-omp-3d -lboost_system -lboost_filesystem -ffast-math -flto -march=native -msse4.2 -funroll-loops -xhost -O3
